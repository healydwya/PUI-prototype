                ...
                <div className="details">
                    ...
                    <div className="row size">
                        <div className="dropdowns">
                            <select onChange={() => setSize(sizes.value)} id="sizes" name="sizes">
                                <option onChange={() => setSize('large')} value={"large"}>Large</option>
                    ...
                    <div className="row cart">
                        <img onClick={() => dispatch(incrementByAmount({ quant, size, color }))} alt="add to cart" src="Assets/add-button.png" className="add-button"></img>
